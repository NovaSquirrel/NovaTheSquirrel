...
introlevelData:
  ...
  LObj  LO::S_CUSTOM,         1, 6, Metatiles::BRICKPRIZE
  LObj  LO::S_SIGNPOST,       0, 12
  LObj  LO::R_CUSTOM,         1, 9, Metatiles::BRICKPRIZE, (1<<4)|0
  LObj  LO::S_SOLID_BLOCK,    4, 11
  LObjN LO::R_GROUND,         0, 12, 8, 0
  LObj  LO::S_SOLID_BLOCK,    8, 11
  LObj  LO::S_COIN,           0, 9
  ...
  LObjN LO::R_GROUND,         3, 12, 2, 2
  LObjN LO::WIDE_1,           0, 10, 9, LN1::SOLID_LEDGE
  LObj  LO::S_PRIZE,          2, 6
  ...
  LObjN LO::R_GROUND,         1, 12, 9, 0
  LObj  LO::S_GROUND_CLIMB_L, 0, 11
  LObj  LO::S_GROUND_CLIMB_L, 1, 10
  ...
  LObjN LO::R_COIN,           2, 6, 0, 1
  LObjN LO::R_COIN,           0, 3, 0, 1
  ...
  LObjN LO::WIDE_1,           2, 11, 11, LN1::SOLID_LEDGE
  LObjN LO::R_SOLID_BLOCK,    0, 6, 0, 4
