...
glasscaveData:
  ...
  LObjN LO::R_SOLID_ROCK,     4, 10, 1, 4
  LObj  LO::S_PRIZE,          3, 6
  ...
  LObjN LO::R_FG_GLASS_RED,   3, 4, 4, 10
  ...
  LObjN LO::RECT_1,           4, 0, 1, LN1::GROUND, 16
  LObj  LO::R_CUSTOM,         0, 4, Metatiles::FORCE_RIGHT, (7<<4)|0
  LObj  LO::S_SPRING,         1, 7
  LObj  LO::S_SPRING,         0, 10
  LObj  LO::S_SPRING,         0, 13
  LObjN LO::WIDE_1,           0, 14, 12, LN1::SOLID_LEDGE
  LObj  LO::R_CUSTOM,         3, 8, Metatiles::FORCE_DOWN, (0<<4)|3
  LObj  LO::R_CUSTOM,         0, 12, Metatiles::FORCE_RIGHT, (6<<4)|0
  LObj  LO::R_CUSTOM,         1, 8, Metatiles::FORCE_LEFT, (3<<4)|0
  LObj  LO::R_CUSTOM,         3, 4, Metatiles::FORCE_DOWN, (0<<4)|3
  LObj  LO::R_CUSTOM,         3, 4, Metatiles::FORCE_RIGHT, (5<<4)|0
  LObj  LO::R_CUSTOM,         0, 5, Metatiles::FORCE_UP, (0<<4)|7
  LObjN LO::R_GROUND,         3, 7, 4, 7
  LObj  LO::S_CUSTOM,         3, 6, Metatiles::GREEN_BOOTS
  LFinished
