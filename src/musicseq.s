...
PEDAT_autotriangle1 = PEDAT_autotriangleb + 0
PEDAT_autotriangle2:
...
PIDAT_Boss_Bass = PEDAT_autotriangleb + 14
PIDAT_Boss_Arp_Hit:
...
pently_patterns:  ; 229 entries, 11164 bytes
...
.byte CHVOLUME,2,VIBRATO,3,N_C|D_2,CHVOLUME,3,N_TIE|D_4,CHVOLUME,4,N_TIE|D_4
.byte CHVOLUME,2,N_D|D_2,CHVOLUME,3,N_TIE|D_4,CHVOLUME,4,N_TIE|D_4,N_F|D_2
.byte CHVOLUME,3,N_TIE|D_4,CHVOLUME,2,N_TIE|D_4,N_E|D_2,CHVOLUME,3,N_D|D_4
.byte CHVOLUME,4,N_TIE|D_4,PATEND
PPDAT_World_1A_pat_2_0_5:
.byte CHVOLUME,2,VIBRATO,3,N_C|D_2,CHVOLUME,3,N_TIE|D_4,CHVOLUME,4,N_TIE|D_4
.byte CHVOLUME,2,N_D|D_2,CHVOLUME,3,N_TIE|D_4,CHVOLUME,4,N_TIE|D_4,N_F|D_2
.byte CHVOLUME,3,N_TIE|D_4,CHVOLUME,2,N_TIE|D_4,N_G|D_2,CHVOLUME,3,N_A|D_4
.byte CHVOLUME,2,N_G|D_4,PATEND
PPDAT_World_1A_pat_2_0_6:
.byte CHVOLUME,2,VIBRATO,3,N_C|D_2,CHVOLUME,3,N_TIE|D_4,CHVOLUME,4,N_TIE|D_4
.byte CHVOLUME,2,N_D|D_2,CHVOLUME,3,N_TIE|D_4,CHVOLUME,4,N_TIE|D_4,N_F|D_2
.byte CHVOLUME,3,N_TIE|D_8,N_G|D_8,CHVOLUME,2,N_TIE|D_8,N_F|D_8,N_G|D_4,N_A|D_4
...
.byte CHVOLUME,3,VIBRATO,3,N_C|D_D8,CHVOLUME,2,N_TIE|D_D4,N_TIE
...
.byte CHVOLUME,4,N_CH,CHVOLUME,2,N_TIE,CHVOLUME,4,N_CH,CHVOLUME,2,N_TIE
.byte CHVOLUME,4,N_CH|D_8,N_DH|D_8,CHVOLUME,2,N_TIE,CHVOLUME,4,N_FH|D_8
.byte CHVOLUME,2,N_TIE,INSTRUMENT,PI_Miniboss_Flute,CHVOLUME,4,N_DH|D_8,N_CH
.byte N_DH|D_8,N_EH|D_D8,N_FH,N_A|D_D8,INSTRUMENT,PI_Select_Orc_Hit,N_CH
.byte CHVOLUME,2,N_TIE,CHVOLUME,4,N_B,CHVOLUME,2,N_TIE,CHVOLUME,4,N_G
.byte CHVOLUME,2,N_TIE,CHVOLUME,4,N_F|D_8,CHVOLUME,2,N_TIE,CHVOLUME,4,N_C|D_8
.byte CHVOLUME,2,N_TIE,INSTRUMENT,PI_Miniboss_Flute,CHVOLUME,4,N_DH|D_8,N_EH
...
.byte CHVOLUME,4,N_G|D_8,CHVOLUME,2,N_G,CHVOLUME,4,N_F|D_8,CHVOLUME,2,N_F
.byte CHVOLUME,4,N_G|D_8,CHVOLUME,2,N_G|D_8,CHVOLUME,4,N_F|D_8,N_G,CHVOLUME,2
.byte N_G,CHVOLUME,4,N_F,CHVOLUME,2,N_F,CHVOLUME,4,N_C|D_8,CHVOLUME,2,N_C
.byte CHVOLUME,4,N_C|D_8,CHVOLUME,2,N_C,CHVOLUME,4,N_D|D_8,CHVOLUME,2,N_D|D_8
.byte CHVOLUME,4,N_F|D_8,CHVOLUME,2,N_F|D_4,CHVOLUME,4,N_G|D_8,CHVOLUME,2,N_G
.byte CHVOLUME,4,N_F|D_8,CHVOLUME,2,N_F,CHVOLUME,4,N_G|D_8,CHVOLUME,2,N_G|D_8
.byte CHVOLUME,4,N_F|D_8,N_G,CHVOLUME,2,N_G,CHVOLUME,4,N_F,CHVOLUME,2,N_F
.byte CHVOLUME,4,N_G,CHVOLUME,2,N_G,CHVOLUME,4,N_F,CHVOLUME,2,N_F,CHVOLUME,4
.byte N_G,CHVOLUME,2,N_G,CHVOLUME,4,N_F,CHVOLUME,2,N_F,CHVOLUME,4,N_D
.byte CHVOLUME,2,N_D,CHVOLUME,4,N_C,CHVOLUME,2,N_C,CHVOLUME,4,N_D,CHVOLUME,2
.byte N_D,CHVOLUME,4,N_F,CHVOLUME,2,N_F,PATEND
PPDAT_World_3_pat_4_1_4:
.byte CHVOLUME,4,N_CH|D_8,CHVOLUME,2,N_CH,CHVOLUME,4,N_AS|D_8,CHVOLUME,2,N_AS
.byte CHVOLUME,4,N_CH|D_8,CHVOLUME,2,N_CH|D_8,CHVOLUME,4,N_AS|D_8,N_CH
.byte CHVOLUME,2,N_CH,CHVOLUME,4,N_AS,CHVOLUME,2,N_AS,CHVOLUME,4,N_F|D_8
.byte CHVOLUME,2,N_F,CHVOLUME,4,N_F|D_8,CHVOLUME,2,N_F,CHVOLUME,4,N_G|D_8
.byte CHVOLUME,2,N_G|D_8,CHVOLUME,4,N_AS|D_8,CHVOLUME,2,N_AS|D_4,CHVOLUME,4
.byte N_AS|D_8,CHVOLUME,2,N_AS,CHVOLUME,4,N_G|D_8,CHVOLUME,2,N_G,CHVOLUME,4
.byte N_AS|D_8,CHVOLUME,2,N_AS|D_8,CHVOLUME,4,N_G|D_8,N_AS,CHVOLUME,2,N_AS
.byte CHVOLUME,4,N_G,CHVOLUME,2,N_G,CHVOLUME,4,N_F|D_8,CHVOLUME,2,N_F
.byte CHVOLUME,4,N_F|D_8,CHVOLUME,2,N_F,CHVOLUME,4,N_DS|D_8,CHVOLUME,2,N_DS|D_8
.byte CHVOLUME,4,N_C|D_8,CHVOLUME,2,N_C|D_4,PATEND
PPDAT_World_3_pat_4_1_5:
.byte CHVOLUME,4,N_AH|D_8,N_GH|D_8,N_EH|D_8,N_GH|D_4,INSTRUMENT,PI_Horn
.byte CHVOLUME,3,N_D|D_8,N_E|D_8,N_G,CHVOLUME,2,N_TIE
.byte INSTRUMENT,PI_Pizzicato_Strings,CHVOLUME,4,N_AH|D_8,N_GH|D_8,N_EH|D_8
.byte N_GH|D_4,INSTRUMENT,PI_Horn,CHVOLUME,3,N_D|D_8,N_E|D_8,N_C,CHVOLUME,2
...
.byte CHVOLUME,2,N_TIE,INSTRUMENT,PI_Pizzicato_Strings,CHVOLUME,4,N_AH|D_8
...
.byte CHVOLUME,3,N_C|D_8,N_D|D_8,N_F,CHVOLUME,2,N_F
.byte INSTRUMENT,PI_Pizzicato_Strings,CHVOLUME,4,N_GH|D_8,N_FH|D_8,N_DH|D_8
.byte N_FH|D_4,INSTRUMENT,PI_Horn,CHVOLUME,3,N_C|D_8,N_F|D_8,N_D,CHVOLUME,2
...
.byte CHVOLUME,2,N_TIE,INSTRUMENT,PI_Pizzicato_Strings,CHVOLUME,4,N_GH|D_8
...
.byte CHVOLUME,2,ARPEGGIO,$00,N_DSH|D_8,N_CH|D_8
.byte INSTRUMENT,PI_Distant_Square_Echo,CHVOLUME,4,N_DSH|D_8,N_CH|D_8
.byte INSTRUMENT,PI_Blank,CHVOLUME,2,N_G|D_8,N_DS|D_8
.byte INSTRUMENT,PI_Distant_Square_Echo,CHVOLUME,4,N_G|D_8,N_DS|D_8
.byte INSTRUMENT,PI_Blank,CHVOLUME,2,N_FS|D_8,N_DS|D_8
.byte INSTRUMENT,PI_Distant_Square_Echo,CHVOLUME,4,N_FS|D_8,N_DS|D_8
.byte INSTRUMENT,PI_Blank,CHVOLUME,2,N_DS|D_8,N_C|D_8
.byte INSTRUMENT,PI_Distant_Square_Echo,CHVOLUME,4,N_DS|D_8,N_C|D_8
.byte INSTRUMENT,PI_Blank,CHVOLUME,2,N_DSH|D_8,N_CH|D_8
.byte INSTRUMENT,PI_Distant_Square_Echo,CHVOLUME,4,N_DSH|D_8,N_CH|D_8
.byte INSTRUMENT,PI_Blank,CHVOLUME,2,N_F|D_8,N_C|D_8
.byte INSTRUMENT,PI_Distant_Square_Echo,CHVOLUME,4,N_F|D_8,N_C|D_8
.byte INSTRUMENT,PI_Blank,CHVOLUME,2,N_FS|D_8,N_C|D_8
.byte INSTRUMENT,PI_Distant_Square_Echo,CHVOLUME,4,N_FS|D_8,N_C|D_8
.byte INSTRUMENT,PI_Blank,CHVOLUME,2,N_G|D_8,N_AS|D_8
.byte INSTRUMENT,PI_Distant_Square_Echo,CHVOLUME,4,N_CH|D_8,N_AS|D_8,PATEND
PPDAT_World_2_pat_5_0_2:
.byte CHVOLUME,4,VIBRATO,2,VIBRATO,2,N_F|D_4,N_D|D_4,N_C|D_4,N_CS|D_D8,N_D
.byte N_F|D_8,N_D|D_8,N_F|D_8,N_D|D_8,N_C|D_4,N_D|D_4,N_F|D_4,N_D|D_4,N_C|D_4
.byte N_CS|D_8,N_D|D_8,N_F|D_8,N_D|D_8,N_F|D_8,N_D|D_8,N_GS|D_4,N_G|D_4,PATEND
...
.byte VIBRATO,0,TRANSPOSE,<8,N_CHH|D_8,N_AH|D_8,N_GH|D_8,N_AH,CHVOLUME,2,N_AH
.byte INSTRUMENT,PI_Puzzle_Mellow_Crazy,CHVOLUME,4,VIBRATO,2,VIBRATO,2,N_C|D_4
.byte TRANSPOSE,<-5,N_D|D_4,N_C|D_4,N_CS|D_8,N_D,CHVOLUME,2,N_D
.byte INSTRUMENT,PI_Puzzle_Pulsate,CHVOLUME,4,VIBRATO,0,VIBRATO,0,TRANSPOSE,<26
.byte N_DS|D_8,N_C|D_8,N_DS|D_8,N_C|D_8,N_FS|D_8,N_F|D_8,N_DS|D_8,N_C
.byte CHVOLUME,2,N_C,TRANSPOSE,<-29,PATEND
PPDAT_World_2_pat_5_0_6:
.byte CHVOLUME,4,ARPEGGIO,$00,N_F|D_8,CHVOLUME,2,N_F|D_8,CHVOLUME,4,N_C|D_8
.byte CHVOLUME,2,N_C|D_8,CHVOLUME,4,N_D|D_8,CHVOLUME,2,N_D|D_8,CHVOLUME,4,N_F
.byte CHVOLUME,2,N_F,CHVOLUME,4,N_D|D_8,CHVOLUME,2,N_D|D_8,REST|D_8
.byte INSTRUMENT,PI_Puzzle_Pulsate,CHVOLUME,4,ARPEGGIO,$cc,N_GSH|D_4,N_GH|D_4
.byte N_FH|D_4,INSTRUMENT,PI_Horn,ARPEGGIO,$00,N_F|D_8,CHVOLUME,2,N_F|D_8
.byte CHVOLUME,4,N_C|D_8,CHVOLUME,2,N_C|D_8,CHVOLUME,4,N_D|D_8,CHVOLUME,2
.byte N_D|D_8,CHVOLUME,4,N_F,CHVOLUME,2,N_F,CHVOLUME,4,N_D|D_8,CHVOLUME,2
...
.byte N_FH|D_4,INSTRUMENT,PI_Horn,ARPEGGIO,$00,N_F|D_8,CHVOLUME,2,N_F|D_8
.byte CHVOLUME,4,N_C|D_8,CHVOLUME,2,N_C|D_8,CHVOLUME,4,N_D|D_8,CHVOLUME,2
.byte N_D|D_8,CHVOLUME,4,N_CH,CHVOLUME,2,N_CH,CHVOLUME,4,N_DH|D_8,CHVOLUME,2
...
.byte CHVOLUME,3,VIBRATO,0,N_C,CHVOLUME,2,N_C,CHVOLUME,3,N_E,CHVOLUME,2,N_C
.byte CHVOLUME,3,N_G,CHVOLUME,2,N_E,CHVOLUME,3,N_C,CHVOLUME,2,N_G,CHVOLUME,3
.byte N_E,CHVOLUME,2,N_C,CHVOLUME,3,N_G,CHVOLUME,2,N_E,CHVOLUME,3,N_B
.byte CHVOLUME,2,N_G,CHVOLUME,3,N_CH,CHVOLUME,2,N_B,CHVOLUME,3,N_C,CHVOLUME,2
.byte N_CH,CHVOLUME,3,N_E,CHVOLUME,2,N_C,CHVOLUME,3,N_G,CHVOLUME,2,N_E
.byte CHVOLUME,3,N_C,CHVOLUME,2,N_G,CHVOLUME,3,N_E,CHVOLUME,2,N_C,CHVOLUME,3
.byte N_G,CHVOLUME,2,N_E,CHVOLUME,3,N_A,CHVOLUME,2,N_G,CHVOLUME,3,N_E
.byte CHVOLUME,2,N_A,CHVOLUME,3,N_C,CHVOLUME,2,N_E,CHVOLUME,3,N_E,CHVOLUME,2
.byte N_C,CHVOLUME,3,N_G,CHVOLUME,2,N_E,CHVOLUME,3,N_C,CHVOLUME,2,N_G
.byte CHVOLUME,3,N_E,CHVOLUME,2,N_C,CHVOLUME,3,N_G,CHVOLUME,2,N_E,CHVOLUME,3
.byte N_B,CHVOLUME,2,N_G,CHVOLUME,3,N_CH,CHVOLUME,2,N_B,CHVOLUME,3,N_C
.byte CHVOLUME,2,N_CH,CHVOLUME,3,N_E,CHVOLUME,2,N_C,CHVOLUME,3,N_G,CHVOLUME,2
.byte N_E,CHVOLUME,3,N_C,CHVOLUME,2,N_G,CHVOLUME,3,N_E,CHVOLUME,2,N_C
.byte CHVOLUME,3,N_G,CHVOLUME,2,N_E,CHVOLUME,3,N_E,CHVOLUME,2,N_G,CHVOLUME,3
.byte N_C,CHVOLUME,2,N_E,PATEND
PPDAT_World_5_pat_6_0_12:
.byte CHVOLUME,3,N_C,CHVOLUME,2,N_C,CHVOLUME,3,N_E,CHVOLUME,2,N_C,CHVOLUME,3
.byte N_G,CHVOLUME,2,N_E,CHVOLUME,3,N_C,CHVOLUME,2,N_G,CHVOLUME,3,N_E
.byte CHVOLUME,2,N_C,CHVOLUME,3,N_G,CHVOLUME,2,N_E,CHVOLUME,3,N_B,CHVOLUME,2
.byte N_G,CHVOLUME,3,N_CH,CHVOLUME,2,N_B,CHVOLUME,3,N_C,CHVOLUME,2,N_CH
.byte CHVOLUME,3,N_E,CHVOLUME,2,N_C,CHVOLUME,3,N_G,CHVOLUME,2,N_E,CHVOLUME,3
.byte N_C,CHVOLUME,2,N_G,CHVOLUME,3,N_E,CHVOLUME,2,N_C,CHVOLUME,3,N_G
.byte CHVOLUME,2,N_E,CHVOLUME,3,N_A,CHVOLUME,2,N_G,CHVOLUME,3,N_E,CHVOLUME,2
.byte N_A,CHVOLUME,3,N_C,CHVOLUME,2,N_E,CHVOLUME,3,N_E,CHVOLUME,2,N_C
.byte CHVOLUME,3,N_G,CHVOLUME,2,N_E,CHVOLUME,3,N_C,CHVOLUME,2,N_G,CHVOLUME,3
.byte N_E,CHVOLUME,2,N_C,CHVOLUME,3,N_G,CHVOLUME,2,N_E,CHVOLUME,3,N_B
.byte CHVOLUME,2,N_G,CHVOLUME,3,N_CH,CHVOLUME,2,N_B,CHVOLUME,3,N_C,CHVOLUME,2
.byte N_CH,CHVOLUME,3,N_E,CHVOLUME,2,N_C,CHVOLUME,3,N_G,CHVOLUME,2,N_E
.byte CHVOLUME,3,N_C,CHVOLUME,2,N_G,CHVOLUME,3,N_E,CHVOLUME,2,N_C,CHVOLUME,3
.byte N_G,CHVOLUME,2,N_E,CHVOLUME,3,N_E,CHVOLUME,2,N_G,CHVOLUME,3,N_C
.byte CHVOLUME,2,N_E,PATEND
...
.byte N_C,CHVOLUME,2,N_G,CHVOLUME,3,N_E,CHVOLUME,2,N_C,CHVOLUME,3,N_G
.byte CHVOLUME,2,N_E,CHVOLUME,3,N_A,CHVOLUME,2,N_G,CHVOLUME,3,N_E,CHVOLUME,2
.byte N_A,CHVOLUME,3,N_D,CHVOLUME,2,N_FS,CHVOLUME,3,N_FS,CHVOLUME,2,N_D
.byte CHVOLUME,3,N_A,CHVOLUME,2,N_FS,CHVOLUME,3,N_D,CHVOLUME,2,N_A,CHVOLUME,3
.byte N_FS,CHVOLUME,2,N_D,CHVOLUME,3,N_A,CHVOLUME,2,N_FS,CHVOLUME,3,N_CSH
.byte CHVOLUME,2,N_A,CHVOLUME,3,N_DH,CHVOLUME,2,N_CSH,CHVOLUME,3,N_E,CHVOLUME,2
.byte N_EH,CHVOLUME,3,N_GS,CHVOLUME,2,N_E,CHVOLUME,3,N_B,CHVOLUME,2,N_GS
.byte CHVOLUME,3,N_E,CHVOLUME,2,N_B,CHVOLUME,3,N_GS,CHVOLUME,2,N_E,CHVOLUME,3
.byte N_B,CHVOLUME,2,N_GS,CHVOLUME,3,N_GS,CHVOLUME,2,N_B,CHVOLUME,3,N_E
.byte CHVOLUME,2,N_GS,PATEND
...
.byte CHVOLUME,2,N_E|D_8,N_G|D_8,CHVOLUME,3,N_B|D_8,CHVOLUME,4,N_C|D_8,PATEND
...
.byte REST,CHVOLUME,2,VIBRATO,0,N_C,REST,N_E,REST,N_G,REST,N_C,REST,N_E,REST
...
.byte CHVOLUME,2,N_C|D_8,N_C|D_8,N_C|D_8,N_C|D_8,N_C|D_8,N_C|D_8,N_C|D_8
.byte N_C|D_8,N_C|D_8,N_C|D_8,N_C|D_8,N_C|D_8,N_C|D_8,N_C|D_8,N_C|D_8,N_C|D_8
.byte CHVOLUME,3,N_C|D_8,N_C|D_8,N_C|D_8,N_C|D_8,N_C|D_8,N_C|D_8,N_C|D_8
.byte N_C|D_8,CHVOLUME,2,N_C|D_8,N_C|D_8,N_C|D_8,N_C|D_8,N_C|D_8,N_C|D_8
.byte N_C|D_8,N_C|D_8,PATEND
PPDAT_World_5_pat_6_1_17:
.byte CHVOLUME,2,N_E|D_8,N_E|D_8,N_E|D_8,N_E|D_8,CHVOLUME,3,N_E|D_8,N_E|D_8
.byte CHVOLUME,2,N_E|D_8,N_E|D_8,N_E|D_8,N_E|D_8,N_E|D_8,N_E|D_8,CHVOLUME,3
.byte N_E|D_8,N_E|D_8,CHVOLUME,2,N_E|D_8,N_E|D_8,N_D|D_8,N_D|D_8,N_D|D_8
.byte N_D|D_8,CHVOLUME,3,N_D|D_8,N_D|D_8,CHVOLUME,2,N_D|D_8,N_D|D_8,N_C|D_8
.byte N_C|D_8,N_C|D_8,N_C|D_8,CHVOLUME,3,N_C|D_8,N_C|D_8,CHVOLUME,2,N_C|D_8
.byte N_C|D_8,PATEND
...
.byte CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_E|D_4,N_EH|D_8,CHVOLUME,2,N_TIE|D_8
.byte CHVOLUME,4,N_E|D_8,N_EH|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_E|D_8
.byte N_EH|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_E|D_8,N_EH|D_8,N_E|D_8
.byte CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_EH|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4
.byte N_C|D_4,N_CH|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_C|D_8,N_CH|D_8
.byte CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_C|D_8,N_CH|D_8,CHVOLUME,2,N_TIE|D_8
.byte CHVOLUME,4,N_C|D_8,N_CH|D_8,N_C|D_4,N_CH|D_8,PATEND
PPDAT_Minor_Boss_pat_7_0_1:
.byte CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_F|D_4,N_FH|D_8,CHVOLUME,2,N_TIE|D_8
.byte CHVOLUME,4,N_F|D_8,N_FH|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_F|D_8
.byte N_FH|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_F|D_8,N_FH|D_8,N_F|D_8
.byte CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_FH|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4
.byte N_C|D_4,N_CH|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_C|D_8,N_CH|D_8
.byte CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_C|D_8,N_CH|D_8,CHVOLUME,2,N_TIE|D_8
.byte CHVOLUME,4,N_C|D_8,N_CH|D_8,N_C|D_4,N_CH|D_8,PATEND
...
.byte CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_CH|D_4,N_CHH|D_8,CHVOLUME,2,N_TIE|D_8
.byte CHVOLUME,4,N_CH|D_8,N_CHH|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_CH|D_8
.byte N_CHH|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_CH|D_8,N_CHH|D_8,N_CH|D_8
.byte CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_CHH|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4
.byte N_C|D_4,N_CH|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_C|D_8,N_CH|D_8
.byte CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_C|D_8,N_CH|D_8,CHVOLUME,2,N_TIE|D_8
.byte CHVOLUME,4,N_C|D_8,N_CH|D_8,N_C|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4
...
.byte CHVOLUME,3,VIBRATO,2,VIBRATO,2,N_G|D_1,N_TIE|D_D2,CHVOLUME,2,N_G|D_4
.byte CHVOLUME,3,N_DS|D_1,N_TIE|D_2,N_TIE|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,3
.byte N_C|D_8,CHVOLUME,2,N_TIE|D_8,PATEND
PPDAT_Minor_Boss_pat_7_1_7:
.byte CHVOLUME,3,VIBRATO,2,VIBRATO,2,N_G|D_1,N_TIE|D_D2,CHVOLUME,2,N_A|D_4
.byte CHVOLUME,3,N_F|D_1,N_D|D_2,N_C|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,3
.byte N_D|D_8,CHVOLUME,2,N_TIE|D_8,PATEND
PPDAT_Minor_Boss_pat_7_1_9:
.byte CHVOLUME,3,VIBRATO,2,VIBRATO,2,N_C|D_1,N_TIE|D_D2,CHVOLUME,2,N_C|D_4
.byte CHVOLUME,3,N_F|D_2,N_TIE|D_8,CHVOLUME,2,N_F|D_8,CHVOLUME,3,N_D|D_8
.byte CHVOLUME,2,N_TIE|D_8,CHVOLUME,3,N_F|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,3
.byte N_D|D_8,N_F|D_4,CHVOLUME,2,N_TIE|D_8,CHVOLUME,3,N_D|D_8,CHVOLUME,2
.byte N_TIE|D_8,PATEND
PPDAT_Minor_Boss_pat_7_1_10:
.byte CHVOLUME,3,N_DH|D_4,CHVOLUME,2,N_TIE|D_4,INSTRUMENT,PI_Boss_Arp_Hit
.byte CHVOLUME,4,ARPEGGIO,$37,N_D|D_1,N_D|D_1,N_D|D_1,ARPEGGIO,$59,N_C|D_2
.byte PATEND
...
.byte REST|D_D8,CHVOLUME,2,N_C|D_4,N_CH|D_8,REST|D_8,N_C|D_8,N_CH|D_8,REST|D_8
...
.byte CHVOLUME,2,VIBRATO,2,N_DS|D_1,N_TIE|D_1,N_C|D_1,N_TIE|D_1,PATEND
PPDAT_Major_Boss_pat_8_0_6:
.byte CHVOLUME,2,N_C|D_1,N_TIE|D_D2,N_F|D_4,N_D|D_1,N_TIE|D_1,PATEND
PPDAT_Major_Boss_pat_8_0_7:
.byte CHVOLUME,2,VIBRATO,2,N_C|D_1,N_TIE|D_1,N_DS|D_D2,N_C|D_4,N_DS|D_4,N_C|D_4
.byte N_GS|D_8,N_CH|D_8,N_AS|D_8,N_G|D_8,PATEND
PPDAT_Major_Boss_pat_8_0_8:
.byte N_C|D_2,CHVOLUME,2,N_TIE|D_2,REST,INSTRUMENT,PI_Distant_Square_Echo
...
.byte REST,CHVOLUME,4,VIBRATO,2,ARPEGGIO,$00,N_C|D_4,N_CH|D_8,CHVOLUME,2
.byte N_TIE|D_8,CHVOLUME,4,N_C|D_8,N_CH|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4
.byte N_C|D_8,N_CH|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_C|D_8,N_CH|D_8,N_C|D_4
.byte N_CH|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_C|D_4,N_CH|D_8,CHVOLUME,2
.byte N_TIE|D_8,CHVOLUME,4,N_C|D_8,N_CH|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4
.byte N_C|D_8,N_CH|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_C|D_8,N_CH|D_8,N_C|D_4
.byte N_AS|D_D8,PATEND
PPDAT_Major_Boss_pat_8_1_2:
.byte REST,CHVOLUME,4,N_C|D_4,N_CH|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_C|D_8
.byte N_CH|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_C|D_8,N_CH|D_8,CHVOLUME,2
.byte N_TIE|D_8,CHVOLUME,4,N_C|D_8,N_CH|D_8,N_C|D_4,N_CH|D_8,CHVOLUME,2
.byte N_TIE|D_8,CHVOLUME,4,N_C|D_4,N_CH|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4
.byte N_C|D_8,N_CH|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_C|D_8,N_AS|D_8
.byte CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_G|D_8,N_AS|D_D4,N_CH|D_D8,PATEND
PPDAT_Major_Boss_pat_8_1_4:
.byte CHVOLUME,2,VIBRATO,3,VIBRATO,3,N_E|D_1,N_TIE|D_1,N_C|D_1,N_TIE|D_1,PATEND
PPDAT_Major_Boss_pat_8_1_5:
.byte CHVOLUME,2,N_C|D_1,N_TIE|D_1,N_CS|D_1,N_TIE|D_1,PATEND
...
.byte N_TIE|D_8,CHVOLUME,4,N_C|D_8,N_CH|D_8,N_C|D_4,N_CH|D_8,CHVOLUME,2
.byte N_TIE|D_8,CHVOLUME,4,N_C|D_4,N_CH|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4
.byte N_C|D_8,N_CH|D_8,CHVOLUME,2,N_TIE|D_8,CHVOLUME,4,N_C,INSTRUMENT,PI_Horn
.byte CHVOLUME,2,N_CH|D_4,N_CH|D_4,CHVOLUME,3,N_CH|D_4,CHVOLUME,4,N_CH|D_8
.byte CHVOLUME,2,N_TIE|D_8,PATEND
...
.byte LEGATO_OFF,CHVOLUME,2,N_CSH,LEGATO_ON,N_DSH,LEGATO_OFF,CHVOLUME,3,N_CSH
.byte CHVOLUME,2,N_CSH,CHVOLUME,3,N_CH,CHVOLUME,2,N_CH,PATEND
PPDAT_Final_Boss_pat_9_1_0:
.byte CHVOLUME,3,N_C,CHVOLUME,2,N_D,CHVOLUME,3,N_CH,CHVOLUME,2,N_C,CHVOLUME,3
.byte N_G,CHVOLUME,2,N_CH,CHVOLUME,3,N_C,CHVOLUME,2,N_G,CHVOLUME,3,N_F
.byte CHVOLUME,2,N_C,CHVOLUME,3,N_C,CHVOLUME,2,N_F,CHVOLUME,3,N_G,CHVOLUME,2
.byte N_C,CHVOLUME,3,N_F,CHVOLUME,2,N_G,CHVOLUME,3,N_C,CHVOLUME,2,N_F
.byte CHVOLUME,3,N_CH,CHVOLUME,2,N_C,CHVOLUME,3,N_G,CHVOLUME,2,N_CH,CHVOLUME,3
.byte N_C,CHVOLUME,2,N_G,CHVOLUME,3,N_F,CHVOLUME,2,N_C,CHVOLUME,3,N_G
.byte CHVOLUME,2,N_F,CHVOLUME,3,N_F,CHVOLUME,2,N_G,CHVOLUME,3,N_D,CHVOLUME,2
.byte N_F,CHVOLUME,3,N_C,CHVOLUME,2,N_D,CHVOLUME,3,N_CH,CHVOLUME,2,N_C
.byte CHVOLUME,3,N_G,CHVOLUME,2,N_CH,CHVOLUME,3,N_C,CHVOLUME,2,N_G,CHVOLUME,3
.byte N_F,CHVOLUME,2,N_C,CHVOLUME,3,N_C,CHVOLUME,2,N_F,CHVOLUME,3,N_G
.byte CHVOLUME,2,N_C,CHVOLUME,3,N_F,CHVOLUME,2,N_G,CHVOLUME,3,N_C,CHVOLUME,2
.byte N_F,CHVOLUME,3,N_CH,CHVOLUME,2,N_C,CHVOLUME,3,N_G,CHVOLUME,2,N_CH
.byte CHVOLUME,3,N_C,CHVOLUME,2,N_G,CHVOLUME,3,N_F,CHVOLUME,2,N_C,CHVOLUME,3
.byte N_G,CHVOLUME,2,N_F,CHVOLUME,3,N_DS,CHVOLUME,2,N_G,CHVOLUME,3,N_D
.byte CHVOLUME,2,N_DS,PATEND
...
.byte CHVOLUME,3,N_G,CHVOLUME,2,N_CH,CHVOLUME,3,N_C,CHVOLUME,2,N_G,CHVOLUME,3
.byte N_F,CHVOLUME,2,N_C,CHVOLUME,3,N_C,CHVOLUME,2,N_F,CHVOLUME,3,N_G
.byte CHVOLUME,2,N_C,CHVOLUME,3,N_F,CHVOLUME,2,N_G,CHVOLUME,3,N_G,CHVOLUME,2
.byte N_F,CHVOLUME,3,N_F,CHVOLUME,2,N_G,CHVOLUME,3,N_DS,CHVOLUME,2,N_F
.byte CHVOLUME,3,N_F,CHVOLUME,2,N_DS,CHVOLUME,3,N_DS,CHVOLUME,2,N_F,CHVOLUME,3
.byte N_D,CHVOLUME,2,N_DS,CHVOLUME,3,N_DS,CHVOLUME,2,N_D,CHVOLUME,3,N_D
.byte CHVOLUME,2,N_DS,PATEND
PPDAT_Final_Boss_pat_9_1_2:
.byte CHVOLUME,2,N_D,N_D,N_C,N_D,CHVOLUME,3,N_D,CHVOLUME,2,N_C,CHVOLUME,3,N_F
.byte CHVOLUME,2,N_D,CHVOLUME,3,N_G,CHVOLUME,2,N_F,CHVOLUME,3,N_D,CHVOLUME,2
.byte N_G,CHVOLUME,4,N_F,CHVOLUME,2,N_D,CHVOLUME,4,N_AS,CHVOLUME,2,N_F,PATEND
PPDAT_Final_Boss_pat_9_1_3:
.byte CHVOLUME,3,N_DS,CHVOLUME,2,N_C,CHVOLUME,3,N_CS,CHVOLUME,2,N_DS,CHVOLUME,3
.byte N_C,CHVOLUME,2,N_CS,CHVOLUME,3,N_CS,CHVOLUME,2,N_C,CHVOLUME,3,N_CS
.byte CHVOLUME,2,N_CS,CHVOLUME,3,N_C,CHVOLUME,2,N_CS,CHVOLUME,3,N_DS,CHVOLUME,2
.byte N_C,CHVOLUME,3,N_CS,CHVOLUME,2,N_DS,CHVOLUME,3,N_DS,CHVOLUME,2,N_CS
.byte CHVOLUME,3,N_CS,CHVOLUME,2,N_DS,CHVOLUME,3,N_C,CHVOLUME,2,N_CS,CHVOLUME,3
.byte N_CS,CHVOLUME,2,N_C,CHVOLUME,3,N_CS,CHVOLUME,2,N_CS,CHVOLUME,3,N_F
.byte CHVOLUME,2,N_CS,CHVOLUME,3,N_DS,CHVOLUME,2,N_F,CHVOLUME,3,N_CS,CHVOLUME,2
.byte N_DS,CHVOLUME,3,N_DS,CHVOLUME,2,N_CS,CHVOLUME,3,N_CS,CHVOLUME,2,N_DS
.byte CHVOLUME,3,N_C,CHVOLUME,2,N_CS,CHVOLUME,3,N_CS,CHVOLUME,2,N_C,CHVOLUME,3
.byte N_CS,CHVOLUME,2,N_CS,CHVOLUME,3,N_C,CHVOLUME,2,N_CS,CHVOLUME,3,N_F
.byte CHVOLUME,2,N_C,CHVOLUME,3,N_DS,CHVOLUME,2,N_F,CHVOLUME,3,N_F,CHVOLUME,2
.byte N_DS,CHVOLUME,3,N_DS,CHVOLUME,2,N_F,CHVOLUME,3,N_CS,CHVOLUME,2,N_DS
.byte CHVOLUME,3,N_DS,CHVOLUME,2,N_CS,CHVOLUME,3,N_CS,CHVOLUME,2,N_DS
.byte CHVOLUME,3,N_DS,CHVOLUME,2,N_CS,CHVOLUME,3,N_CS,CHVOLUME,2,N_DS
.byte CHVOLUME,3,N_C,CHVOLUME,2,N_CS,PATEND
...
.byte CHVOLUME,4,N_C|D_8,N_G|D_8,N_CH,CHVOLUME,2,N_CH,REST
...
.byte CHVOLUME,2,N_CH,REST,INSTRUMENT,PI_Select_Lead_2,CHVOLUME,4,TRANSPOSE,<29
.byte N_C|D_D8,N_E|D_8,N_D|D_8,REST|D_8,INSTRUMENT,PI_Select_Lead_1
.byte TRANSPOSE,<-29,N_C|D_8,N_CH|D_8,N_G,CHVOLUME,2,N_G,REST
...
.byte CHVOLUME,2,N_C,INSTRUMENT,PI_Select_Lead_2,CHVOLUME,4,TRANSPOSE,<26,N_D
.byte N_DS,N_F,N_DS,N_C,N_D,N_G|D_8,N_A|D_8,TRANSPOSE,<-26,PATEND
PPDAT_World_Select_1_pat_10_1_0:
.byte REST,CHVOLUME,2,N_C|D_8,N_G|D_8,N_CH,N_CH,REST
...
.byte TRANSPOSE,<-7,N_C,CHVOLUME,2,N_C,INSTRUMENT,PI_Select_Lead_2,CHVOLUME,4
.byte TRANSPOSE,<26,N_D,N_DS,N_F,N_DS,N_C,N_D,N_G,N_F,N_A|D_8,TRANSPOSE,<-26
.byte PATEND
PPDAT_World_Select_2_pat_11_1_0:
.byte REST,CHVOLUME,2,VIBRATO,1,N_C|D_8,N_G|D_8,N_CH,N_CH,REST
...
.byte CHVOLUME,4,N_C|D_8,INSTRUMENT,PI_Select_Lead_1,N_G|D_8,N_CH,CHVOLUME,2
...
.byte INSTRUMENT,PI_Select_Lead_1,N_CH|D_8,N_FH,CHVOLUME,2,N_FH,REST
...
.byte INSTRUMENT,PI_Select_Lead_1,N_GH|D_8,N_DH,CHVOLUME,2,N_DH,REST
...
.byte INSTRUMENT,PI_Select_Lead_1,N_GH|D_8,N_CH,CHVOLUME,2,N_CH
...
.byte CHVOLUME,4,VIBRATO,0,N_FH|D_D8,INSTRUMENT,PI_Select_Lead_1,CHVOLUME,2
...
.byte N_CH|D_D8,INSTRUMENT,PI_Select_Lead_1,CHVOLUME,2,VIBRATO,1,N_C|D_8,N_F
...
.byte N_F|D_D8,INSTRUMENT,PI_Select_Lead_1,CHVOLUME,2,VIBRATO,1,N_C|D_8
...
.byte INSTRUMENT,PI_Select_Lead_1,CHVOLUME,2,VIBRATO,1,N_C|D_8,N_F,N_F,REST
...
.byte INSTRUMENT,PI_Select_Lead_1,CHVOLUME,2,VIBRATO,1,N_C|D_8,TRANSPOSE,<-5
.byte N_C,N_C,REST,INSTRUMENT,PI_Banjo,CHVOLUME,3,N_CH|D_8
.byte INSTRUMENT,PI_Select_Lead_2,CHVOLUME,2,N_AH,INSTRUMENT,PI_Banjo
.byte CHVOLUME,3,N_AS|D_D8,N_A|D_8,INSTRUMENT,PI_Select_Orc_Hit,CHVOLUME,4
.byte VIBRATO,0,N_F|D_D8,INSTRUMENT,PI_Select_Lead_1,CHVOLUME,2,VIBRATO,1
...
.byte CHVOLUME,2,N_CH,REST,INSTRUMENT,PI_Puzzle_Pulsate,CHVOLUME,4
.byte TRANSPOSE,<24,N_D|D_8,N_C,N_D,N_E,N_C|D_4,INSTRUMENT,PI_Select_Orc_Hit
.byte TRANSPOSE,<-29,N_C|D_8,INSTRUMENT,PI_Horn,N_CH|D_8,N_FH,CHVOLUME,2,N_FH
...
.byte N_C|D_8,INSTRUMENT,PI_Horn,N_GH|D_8,N_DH,CHVOLUME,2,N_DH,REST
...
.byte N_C|D_8,INSTRUMENT,PI_Horn,N_GH|D_8,N_CH,CHVOLUME,2,N_CH
.byte INSTRUMENT,PI_Pizzicato_Strings,CHVOLUME,4,TRANSPOSE,<38,N_D,N_DS,N_F
.byte N_DS,N_C,N_D,N_G,N_F,N_A,CHVOLUME,2,N_TIE,TRANSPOSE,<-26,PATEND
PPDAT_World_Select_5_pat_13_1_0:
.byte CHVOLUME,4,VIBRATO,0,N_FH|D_D8,INSTRUMENT,PI_Horn,CHVOLUME,2,VIBRATO,1
...
.byte INSTRUMENT,PI_Select_Orc_Hit,CHVOLUME,4,VIBRATO,0,N_CH|D_D8
.byte INSTRUMENT,PI_Horn,CHVOLUME,2,VIBRATO,1,N_C|D_8,N_F,N_F,REST
.byte INSTRUMENT,PI_Puzzle_Pulsate,N_ASH|D_8,N_CHH,TRANSPOSE,<5,N_AH
.byte INSTRUMENT,PI_Banjo,CHVOLUME,3,N_G,N_F,N_E,N_C
.byte INSTRUMENT,PI_Select_Orc_Hit,CHVOLUME,4,VIBRATO,0,N_F|D_D8
.byte INSTRUMENT,PI_Horn,CHVOLUME,2,VIBRATO,1,N_C|D_8,TRANSPOSE,<-5,N_C,N_C
.byte REST,INSTRUMENT,PI_Banjo,CHVOLUME,3,N_CH|D_8,INSTRUMENT,PI_Puzzle_Pulsate
.byte CHVOLUME,2,N_AH,INSTRUMENT,PI_Banjo,CHVOLUME,3,N_AS|D_D8,N_A|D_8
.byte INSTRUMENT,PI_Select_Orc_Hit,CHVOLUME,4,VIBRATO,0,N_F|D_D8
.byte INSTRUMENT,PI_Horn,CHVOLUME,2,VIBRATO,1,N_C|D_8,TRANSPOSE,<-7,N_C,N_C
...
; Total music data size: 14010 bytes
...
; pently_patterns: 11164 bytes
;   PP_World_1A_pat_2_0_0: 39 bytes
;   PP_World_1A_pat_2_0_1: 39 bytes
;   PP_World_1A_pat_2_0_4: 37 bytes
;   PP_World_1A_pat_2_0_5: 37 bytes
;   PP_World_1A_pat_2_0_6: 40 bytes
...
;   PP_World_1A_pat_2_1_9: 34 bytes
...
;   PP_World_2_pat_5_0_2: 31 bytes
;   PP_World_2_pat_5_0_4: 73 bytes
...
;   PP_World_5_pat_6_0_16: 71 bytes
...
;   PP_World_5_pat_6_1_16: 41 bytes
;   PP_World_5_pat_6_1_17: 53 bytes
...
;   PP_Minor_Boss_pat_7_1_6: 28 bytes
;   PP_Minor_Boss_pat_7_1_7: 28 bytes
;   PP_Minor_Boss_pat_7_1_9: 46 bytes
;   PP_Minor_Boss_pat_7_1_10: 21 bytes
...
;   PP_Major_Boss_pat_8_0_5: 11 bytes
;   PP_Major_Boss_pat_8_0_6: 10 bytes
;   PP_Major_Boss_pat_8_0_7: 17 bytes
;   PP_Major_Boss_pat_8_0_8: 37 bytes
;   PP_Major_Boss_pat_8_1_0: 65 bytes
;   PP_Major_Boss_pat_8_1_2: 60 bytes
;   PP_Major_Boss_pat_8_1_4: 13 bytes
;   PP_Major_Boss_pat_8_1_5: 9 bytes
;   PP_Major_Boss_pat_8_1_6: 37 bytes
;   PP_Major_Boss_pat_8_1_7: 46 bytes
;   PP_Major_Boss_pat_8_1_8: 66 bytes
...
;   PP_Final_Boss_pat_9_1_2: 45 bytes
...
; Breakdown by song
;   Shared: 1240 bytes
;   Song Final_Boss: 1183 bytes
;   Song Major_Boss: 1166 bytes
;   Song Minor_Boss: 1698 bytes
;   Song World_1A: 1158 bytes
;   Song World_1B: 1057 bytes
;   Song World_2: 1308 bytes
;   Song World_3: 1152 bytes
;   Song World_5: 2303 bytes
