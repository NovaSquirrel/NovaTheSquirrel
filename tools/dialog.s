...
; <1 SIGN>Press and hold Select to get rid of the ability you have. If an enemy throws projectiles, it is usually copyable.
.byt SCR::SAY, SCR::SPEAKER_1|CHAR::SIGN, "P", $fa, $f0, " ", $a3, "h", "o", $ee, " ", "S", "e", "l", "e", $c6, " ", $ba, $ae, SCR::NEWLINE, $fc, $ff, $bc, $a1, " ", "a", "b", $db, "i", "t", $fe, $a5, " ", "h", "a", "v", "e", $f5, "I", "f", SCR::NEWLINE, $c9, " ", $e5, "e", $ca, " ", $df, "r", "o", "w", $fb, "p", "r", "o", "j", "e", $c6, $db, "e", "s", ",", SCR::NEWLINE, $c0, $b7, "u", "s", "u", $ac, $fe, "c", "o", "p", "y", "a", "b", "l", "e", "."
